...
Public Class FormMTMSearchUriageV2
    '---------------------
    '条件値
    '---------------------
    ...
    Private Sub SetDataGridColumn()
        ...
        ' ヘッダーの設定
        DataGridView001.Cols(1).Caption = "売上日"
        DataGridView001.Cols(1).DataType = GetType(String)
        DataGridView001.Cols(1).Name = "HANR002001"
        DataGridView001.Cols(1).AllowSorting = True
        DataGridView001.Cols(1).Width = 80
        ...
        DataGridView001.SetCellStyle(0, 1, newStyle3)

        DataGridView001.Cols(2).Caption = "商品C"
        DataGridView001.Cols(2).DataType = GetType(String)
        DataGridView001.Cols(2).Name = "HANR002019"
        DataGridView001.Cols(2).AllowSorting = True
        DataGridView001.Cols(2).Width = 90
        ...
        DataGridView001.SetCellStyle(0, 2, newStyle3)

        DataGridView001.Cols(3).Caption = "規格"
        DataGridView001.Cols(3).DataType = GetType(String)
        DataGridView001.Cols(3).Name = "HANR002A002"
        ...
        DataGridView001.Cols(4).Caption = "商品名１"
        DataGridView001.Cols(4).DataType = GetType(String)
        DataGridView001.Cols(4).Name = "HANR002020"
        DataGridView001.Cols(4).AllowSorting = True
        DataGridView001.Cols(4).Width = 250
        ...
        DataGridView001.SetCellStyle(0, 4, newStyle3)

        DataGridView001.Cols(5).Caption = "商品名２"
        DataGridView001.Cols(5).DataType = GetType(String)
        DataGridView001.Cols(5).Name = "HANR002118"
        DataGridView001.Cols(5).AllowSorting = True
        DataGridView001.Cols(5).Width = 150
        ...
        DataGridView001.Cols(6).Caption = "入数"
        DataGridView001.Cols(6).DataType = GetType(String)
        DataGridView001.Cols(6).Name = "HANR002022"
        ...
        DataGridView001.Cols(7).Name = "HANR002025"
        DataGridView001.Cols(7).AllowSorting = False
        DataGridView001.Cols(7).Width = 60
        ...
        DataGridView001.Cols(8).Caption = "単位"
        DataGridView001.Cols(8).DataType = GetType(String)
        DataGridView001.Cols(8).Name = "HANR002021"
        DataGridView001.Cols(8).AllowSorting = False
        DataGridView001.Cols(8).Width = 60
        ...
        DataGridView001.Cols(9).Caption = "売上単価"
        DataGridView001.Cols(9).DataType = GetType(String)
        DataGridView001.Cols(9).Name = "HANR002026"
        ...
        DataGridView001.Cols(10).Caption = "仕入単価"
        DataGridView001.Cols(10).DataType = GetType(String)
        DataGridView001.Cols(10).Name = "HANR002028"
        ...
        DataGridView001.Cols(11).Caption = "粗利率"
        DataGridView001.Cols(11).DataType = GetType(String)
        DataGridView001.Cols(11).Name = "ARARI"
        DataGridView001.Cols(11).AllowSorting = False
        DataGridView001.Cols(11).Width = 80
        DataGridView001.Cols(11).TextAlign = TextAlignEnum.RightCenter
        ...
        DataGridView001.Cols(12).Caption = "売上金額"
        DataGridView001.Cols(12).DataType = GetType(String)
        DataGridView001.Cols(12).Name = "HANR002027"
        ...
        DataGridView001.Cols(13).Caption = "仕入金額"
        DataGridView001.Cols(13).DataType = GetType(String)
        DataGridView001.Cols(13).Name = "SHIIRE_TANKA"
        ...
        DataGridView001.Cols(14).Caption = "手配"
        DataGridView001.Cols(14).DataType = GetType(String)
        DataGridView001.Cols(14).Name = "HANM031003"
        DataGridView001.Cols(14).AllowSorting = False
        DataGridView001.Cols(14).Width = 60
        DataGridView001.Cols(14).TextAlign = TextAlignEnum.LeftCenter
        ...
        DataGridView001.Cols(15).Caption = "納品先名１"
        DataGridView001.Cols(15).DataType = GetType(String)
        DataGridView001.Cols(15).Name = "HANM007003"
        DataGridView001.Cols(15).AllowSorting = True
        DataGridView001.Cols(15).Width = 220
        ...
        DataGridView001.SetCellStyle(0, 15, newStyle3)

        DataGridView001.Cols(16).Caption = "納品先名２"
        DataGridView001.Cols(16).DataType = GetType(String)
        DataGridView001.Cols(16).Name = "HANM007005"
        DataGridView001.Cols(16).AllowSorting = True
        DataGridView001.Cols(16).Width = 150
        DataGridView001.Cols(16).TextAlign = TextAlignEnum.LeftCenter
        DataGridView001.Cols(16).AllowEditing = False
        DataGridView001.Cols(16).Style.BackColor = Color.White
        DataGridView001.SetCellStyle(0, 16, newStyle3)

        DataGridView001.Cols(17).Caption = "仕入先略称"
        DataGridView001.Cols(17).DataType = GetType(String)
        DataGridView001.Cols(17).Name = "HANM002006"
        DataGridView001.Cols(17).AllowSorting = False
        DataGridView001.Cols(17).Width = 180
        ...
        'DataGridView001.Cols(17).Caption = "空き"
        'DataGridView001.Cols(17).DataType = GetType(String)
        'DataGridView001.Cols(17).Name = "HANR002A002"
        'DataGridView001.Cols(17).Visible = False
        'DataGridView001.Cols(17).AllowSorting = False
        'DataGridView001.Cols(17).Width = 180
        'DataGridView001.Cols(17).TextAlign = TextAlignEnum.LeftCenter
        'DataGridView001.Cols(17).AllowEditing = False
