...
Namespace Biz
    ...
    Public Class MTM03Print
        ...
        Public Function PrintPreview2(ByVal result As MTM03SearchResult, ByVal outputPath As String, ByVal templatePath As String, ByRef createPdf As String) As Boolean
            Dim PrintItem As New H_Print
